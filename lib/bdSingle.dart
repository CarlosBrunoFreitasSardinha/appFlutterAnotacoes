...
class bdSingle extends StatefulWidget {
  @override
  _bdSingleState createState() => _bdSingleState();
}

class _bdSingleState extends State<bdSingle> {

  _recuperarBancoDados() async{
    final caminhoBancoDados = await getDatabasesPath();
    final localBancoDados = join(caminhoBancoDados.toString(),"banco.bd");

    var bd = await openDatabase(
      localBancoDados,
      version: 1,
      onCreate: (bd, dbVersaoRecente){
